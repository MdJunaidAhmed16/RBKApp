  ...
  Disease({required this.name, required this.imagePath}) {
    ...
    switch (name) {
      ...
      case "Tomato Bacterial Spot":
        ...
        break;
      case "Corn Northern Blight":
        possibleCauses =
            "Northern corn leaf blight (NCLB), caused by the fungus Exserohilum turcicum, is an increasingly important disease in the U.S. Corn Belt";
        possibleSolution =
            "Treating northern corn leaf blight involves using various fungicides";
        break;
